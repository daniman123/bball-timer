...
const Timer: React.FC<TimerProps> = ({ setTimeUp }) => {
  ...
  const audioFiles = useMemo(() => [
    new Howl({ src: ['/sfx/Discord Stream Start - sound effect.mp3'] }),
    new Howl({ src: ['/sfx/10 Seconds Left Female Voiceline Valorant Gaming Sound Effect HD.mp3'] }),
    new Howl({ src: ['/sfx/Right - Sound Effect.mp3'] }),
    new Howl({ src: ['/sfx/Left - Sound Effect.mp3'] }),
    new Howl({ src: ['/sfx/_Time Over!_ Sound Effect.mp3'] }),
    new Howl({ src: ['/sfx/GTA ( mission complete ) sound effect.mp3'] }),
  ], []);
