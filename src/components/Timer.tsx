...
const Timer: React.FC<TimerProps> = ({ setTimeUp }) => {
  ...
  const audioFiles = useMemo(() => [
    new Howl({ src: [process.env.PUBLIC_URL+'//bball-timer/sfx/Discord Stream Start - sound effect.mp3'] }),
    new Howl({ src: [process.env.PUBLIC_URL+'//bball-timer/sfx/10 Seconds Left Female Voiceline Valorant Gaming Sound Effect HD.mp3'] }),
    new Howl({ src: [process.env.PUBLIC_URL+'//bball-timer/sfx/Right - Sound Effect.mp3'] }),
    new Howl({ src: [process.env.PUBLIC_URL+'//bball-timer/sfx/Left - Sound Effect.mp3'] }),
    new Howl({ src: [process.env.PUBLIC_URL+'//bball-timer/sfx/_Time Over!_ Sound Effect.mp3'] }),
    new Howl({ src: [process.env.PUBLIC_URL+'//bball-timer/sfx/GTA ( mission complete ) sound effect.mp3'] }),
  ], []);
